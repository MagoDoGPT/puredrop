...
description: Expert system for creating new Antigravity skills. Provides standards, templates, and validation rules for generating high-quality skill directories. Use this when the user asks to create or generate a new skill.
---
